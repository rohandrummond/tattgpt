...
namespace TattGPT
{
    internal class API 
    {
        ...
        private static async Task<JsonDocument> GenerateIdeas (ChatClient client, IdeaFormData ideaFormData)
        {
            ...
            string formattedPrompt = string.Join("", prompt) + ". Keep the designs simple and timeless, avoiding overly specific details. Each idea should be concise (1-3 words). The description should be a sentence between 60-80 characters, and provide just enough detail to inspire the design without being overly complex.";
